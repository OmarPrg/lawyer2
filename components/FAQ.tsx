...
const faqs = [
  ...
  },
  {
    ...
    answer: "يمكنك حجز موعد بسهولة عبر الاتصال بنا مباشرة، أو التواصل عبر الواتساب من خلال الأيقونة العائمة، أو زيارة مقرنا في المنصورة. نوفر استشارات حضورية وعن بعد حسب رغبة العميل."
  },
  {
    question: "هل يقدم المكتب تمثيلاً قانونياً أمام جميع المحاكم؟",
    answer: "نعم، مكتبنا مرخص للتمثيل والترافع أمام جميع المحاكم المصرية بمختلف درجاتها، بما في ذلك المحاكم العامة، الجزائية، التجارية، العمالية، ومجلس الدولة."
  },
  {
