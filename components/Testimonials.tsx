...
const testimonialsData: Testimonial[] = [
  {
    ...
    content: 'كان لمكتب الأستاذ شعبان عبد الناصر دور حاسم في فك نزاع تجاري معقد لشركتنا. لقد أظهروا مستوى غير مسبوق من الاحترافية، الدقة، والفهم العميق للقوانين التجارية.',
    rating: 5,
  },
  {
    id: 2,
