            ...
            <SlideInLeft>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-primary text-[#616161] text-sm">الدقهلية - المنصورة - طلخا - أمام مجمع المحاكم.</p>
                </div>
              </div>
            </SlideInLeft>
            ...
            <SlideInLeft>
              <div className="flex items-start gap-4">
                ...
                <div className="text-right" dir="ltr">
                  ...
                  <p className="font-primary text-[#616161] text-sm font-semibold">+20 01018155874</p>
                  <p className="font-primary text-[#616161] text-sm font-semibold">+20 0104028582</p>
                </div>
              </div>
            </SlideInLeft>
            ...
            <SlideInLeft>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-primary text-[#616161] text-sm font-semibold">shaban.law.office@gmail.com</p>
                </div>
              </div>
            </SlideInLeft>
            ...
            <SlideInLeft>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-primary text-[#616161] text-sm">السبت - الخميس: 10:00 صباحاً حتي 8:00 مساءً</p>
                </div>
              </div>
            </SlideInLeft>
