        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => (
            <SlideUp   key={service.id} className="h-full">
              ...
              <div
                className="group h-full bg-[#131313]/40 border border-white/10 hover:border-[#4870bb]/60 backdrop-blur-md rounded-2xl p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(72,112,187,0.15)] flex flex-col items-start text-right relative overflow-hidden"
              >
