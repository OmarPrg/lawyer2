...
import { SlideInRight, SlideUp, StaggerContainer, StaggerItem, TextReveal } from "@/components/ui/scroll-animations";
    ...
    <section id="why-us" className="py-24 bg-[#f6f6f6] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <SlideInRight className="flex-1 w-full text-right">
            ...
            <h2 className="text-3xl lg:text-5xl font-extrabold font-display leading-[1.4] text-[#1c0305] mb-6 text-right">
              <TextReveal text="نلتزم بحماية حقوقك" />
              <div className="mt-2">
                <span className=" bg-clip-text bg-gradient-to-l from-[#25395e] to-[#4870bb] inline-block">
                  <TextReveal text="عبر ممارسات قانونية استثنائية" />
                </span>
              </div>
            </h2>
          ...
          <div className="flex-1 w-full relative">
            <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative">
              {features.map((feature, index) => (
                <SlideUp key={index}>
                  <div
                    className={`bg-white rounded-2xl p-8 border border-[#e2e8f0] shadow-[0_15px_40px_rgba(37,57,94,0.04)] hover:shadow-[0_25px_50px_rgba(72,112,187,0.1)] hover:-translate-y-2 transition-all duration-300 flex flex-col text-right h-full ${index % 2 !== 0 ? 'sm:mt-12' : ''
                      }`}
                  >
