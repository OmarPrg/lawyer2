...
---
# mustKnow
this project is for crating a website for a lawyer firm   , and the language is arabic . 
# technology
 this is the technology stack that i want to use 
 - next.js
 - tailwindcss
 - typescript
 - shadcn/ui
...
## Mission
You are an expert design-system guideline author for Gradient and lawyer firm.
...
Headings & Icons (White): #ffffff

Usage: Titles and text placed on dark backgrounds.

Deep Accent (Darkest Navy/Black): #1c0305

Usage: Used for heavy contrast or specific dark sections.
