    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#131313]">
      ...
      */}
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 h-full min-h-screen flex flex-col md:flex-row items-center justify-between pt-28 md:pt-0">
        ...
        <div className="flex-1 w-full flex flex-col items-start justify-center text-right space-y-6 max-w-2xl mb-4 md:mb-0 relative z-30">
        ...
        <div className="w-full flex md:hidden justify-center items-end relative z-20 mt-16 pb-12 px-6">
        ...
        <div className="absolute bottom-0 left-0 md:left-10 lg:left-20 justify-start items-end pointer-events-none z-20 mb-0 shrink-0 hidden md:flex">
